...
################################################################################
## Form generated from reading UI file 'vincularCotacaoManualIMLpth.ui'
##
...
class Ui_VinculaPedidoManual(object):
    def setupUi(self, Ui_VinculaPedidoManual):
        ...
        Ui_VinculaPedidoManual.resize(500, 300)
        Ui_VinculaPedidoManual.setMinimumSize(QSize(500, 300))
        Ui_VinculaPedidoManual.setMaximumSize(QSize(500, 300))
        self.styleSheet = QWidget(Ui_VinculaPedidoManual)
        self.styleSheet.setObjectName(u"styleSheet")
        self.styleSheet.setMinimumSize(QSize(500, 250))
        self.styleSheet.setMaximumSize(QSize(500, 300))
        font = QFont()
...
"height:25 px;")
        ...
        Ui_VinculaPedidoManual.setCentralWidget(self.styleSheet)
        ...
        QWidget.setTabOrder(self.closeAppBtn, self.lineEdit_3)
        QWidget.setTabOrder(self.lineEdit_3, self.lineEdit_4)

        self.retranslateUi(Ui_VinculaPedidoManual)

        QMetaObject.connectSlotsByName(Ui_VinculaPedidoManual)
    # setupUi

    def retranslateUi(self, Ui_VinculaPedidoManual):
        Ui_VinculaPedidoManual.setWindowTitle(QCoreApplication.translate("Ui_VinculaPedidoManual", u"MainWindow", None))
        self.titleRightInfo.setText(QCoreApplication.translate("Ui_VinculaPedidoManual", u"Vincular cota\u00e7\u00e3o Manualmente", None))
#if QT_CONFIG(tooltip)
        self.closeAppBtn.setToolTip(QCoreApplication.translate("Ui_VinculaPedidoManual", u"Close", None))
#endif // QT_CONFIG(tooltip)
        self.closeAppBtn.setText("")
        self.label.setText(QCoreApplication.translate("Ui_VinculaPedidoManual", u"Digite o numero do Pedido:", None))
        self.label_2.setText(QCoreApplication.translate("Ui_VinculaPedidoManual", u"Tranportadora", None))
        self.comboBox.setItemText(0, QCoreApplication.translate("Ui_VinculaPedidoManual", u"Escolha uma transportadora", None))
        self.comboBox.setItemText(1, QCoreApplication.translate("Ui_VinculaPedidoManual", u"RODONAVES", None))
        self.comboBox.setItemText(2, QCoreApplication.translate("Ui_VinculaPedidoManual", u"DIRECIONAL", None))
        self.comboBox.setItemText(3, QCoreApplication.translate("Ui_VinculaPedidoManual", u"MID", None))
        self.comboBox.setItemText(4, QCoreApplication.translate("Ui_VinculaPedidoManual", u"TRANSREIS", None))
        self.comboBox.setItemText(5, QCoreApplication.translate("Ui_VinculaPedidoManual", u"ALLIEX", None))
        self.comboBox.setItemText(6, QCoreApplication.translate("Ui_VinculaPedidoManual", u"SAO MIGUEL", None))
